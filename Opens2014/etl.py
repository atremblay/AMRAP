...
def load_data(db_path):
    ...
    pivoted['15.2'] = pivoted[1].apply(score)
    pivoted['15.2 Rx'] = pivoted[1].apply(Rx)

    pivoted['15.3'] = pivoted[2].apply(score)
    pivoted['15.3 Rx'] = pivoted[2].apply(Rx)

    pivoted['15.4'] = pivoted[3].apply(score)
    pivoted['15.4 Rx'] = pivoted[3].apply(Rx)

    pivoted['15.5'] = pivoted[4].apply(score)
    pivoted['15.5 Rx'] = pivoted[4].apply(Rx)
